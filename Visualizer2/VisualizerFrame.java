...
public class VisualizerFrame extends JFrame {
    ...
    public VisualizerFrame(){
        ...
        ShuffleArray = new JButton("Shuffle Array");
        ...
        sizeVal = new JLabel("Size: 5 values");
        ...
        // Functionality for Shuffle Array
        ShuffleArray.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                SortingVisualizer.shufflearray();
            }
        });
        ...
        size.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                if(SortingVisualizer.isSorting != true)
                    SortingVisualizer.incresesize();
            }
        });
        ...
        buttonWrapper.add(ShuffleArray);
    ...
    public void preDrawArray(Integer[] squares){
        ...
        // 90% of the windows height, divided by the size of the sorted array.
        sizeModifier =  (int) ((getHeight()*0.4)/(squarePanels.length));
        for(int i = 0; i<SortingVisualizer.sortDataCount; i++){
            squarePanels[i] = new JPanel();
            int barValue = squares[i];
            ...
            // adding value to bars
            JLabel label = new JLabel(Integer.toString(barValue));
            label.setHorizontalAlignment(SwingConstants.CENTER);

            // Add the label to the panel
            squarePanels[i].setLayout(new BorderLayout());
            squarePanels[i].add(label, BorderLayout.CENTER);
